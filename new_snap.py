...
def find_discounted_price(product):
...
for product in result_list:
    ...
    discounted_price = find_discounted_price(product)
    # do more here
    # print(product_item.text, price.text, actual_price)
    product_dic = {"name": product_item.text,"actual price": price.text,"discounted price":discounted_price}
